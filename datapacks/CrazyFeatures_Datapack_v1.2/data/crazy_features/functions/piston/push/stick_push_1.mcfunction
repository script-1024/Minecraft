...
execute as @s[tag=m_piston_id4] at @s run clone ^1 ^ ^ ^1 ^ ^ ^2 ^ ^ replace move
execute as @s[tag=m_piston_id4] at @s run clone ^ ^ ^ ^ ^ ^ ^1 ^ ^
execute as @s[tag=m_piston_id5] at @s run clone ^-1 ^ ^ ^-1 ^ ^ ^-2 ^ ^ replace move
execute as @s[tag=m_piston_id5] at @s run clone ^ ^ ^ ^ ^ ^ ^-1 ^ ^
execute as @s[tag=m_piston_id6] at @s run clone ^ ^1 ^ ^ ^1 ^ ^ ^2 ^ replace move
execute as @s[tag=m_piston_id6] at @s run clone ^ ^ ^ ^ ^ ^ ^ ^1 ^
execute as @s[tag=m_piston_id7] at @s run clone ^ ^-1 ^ ^ ^-1 ^ ^ ^-2 ^ replace move
execute as @s[tag=m_piston_id7] at @s run clone ^ ^ ^ ^ ^ ^ ^ ^-1 ^
execute as @s[tag=m_piston_id8] at @s run clone ^ ^1 ^ ^ ^1 ^ ^ ^2 ^ replace move
execute as @s[tag=m_piston_id8] at @s run clone ^ ^ ^ ^ ^ ^ ^ ^1 ^
execute as @s[tag=m_piston_id9] at @s run clone ^ ^-1 ^ ^ ^-1 ^ ^ ^-2 ^ replace move
