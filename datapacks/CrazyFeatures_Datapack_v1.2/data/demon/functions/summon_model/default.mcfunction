...
execute rotated ~ 0 run function demon:summon_model/__generated__/execute/0
execute as @e[type=armor_stand,tag=aj.demon.root_entity,tag=new] run function demon:summon_model/__generated__/execute/1
tag @s remove new