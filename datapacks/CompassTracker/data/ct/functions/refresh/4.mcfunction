...
execute run item replace entity @e[tag=c_m] container.4 with minecraft:compass{display:{Name:' "\\u00a7b追蹤器" '}, tracker:1b, obj:4, LodestoneTracked:0b, LodestonePos:{X:0, Y:0, Z:0}, LodestoneDimension:"minecraft:overworld"} 1
