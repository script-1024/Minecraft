...
execute if score @s element.state matches 3 if score @s counter.attach matches 0 run scoreboard players set @s element.hydro 95
execute unless score @s element.state matches 3 run scoreboard players set @s element.hydro 95
