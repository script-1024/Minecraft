...
scoreboard players set @s timer.freeze 60
execute as @e[tag=ice,distance=..2] unless score @s timer.freeze matches 0.. run scoreboard players set @s timer.freeze 60
