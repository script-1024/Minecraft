...
execute if score @p player.p matches 1 run data modify entity @s data.store[0] set from entity @s data.current
execute if score @p player.p matches 2 run data modify entity @s data.store[1] set from entity @s data.current
execute if score @p player.p matches 3 run data modify entity @s data.store[2] set from entity @s data.current
execute if score @p player.p matches 4 run data modify entity @s data.store[3] set from entity @s data.current
