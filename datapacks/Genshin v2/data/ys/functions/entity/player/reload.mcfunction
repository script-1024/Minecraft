execute if score @p player.p matches 1 run data modify entity @s data.current set from entity @s data.party[0]
execute if score @p player.p matches 2 run data modify entity @s data.current set from entity @s data.party[1]
execute if score @p player.p matches 3 run data modify entity @s data.current set from entity @s data.party[2]
execute if score @p player.p matches 4 run data modify entity @s data.current set from entity @s data.party[3]
