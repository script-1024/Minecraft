...
execute if score @s cjt.stage matches 1 run scoreboard players set @s cjt.out 3
execute if score @s cjt.stage matches 1 run function cjt:crafting/material/cobblestone

execute if score @s cjt.stage matches -5 run scoreboard players set @s cjt.stage 2
