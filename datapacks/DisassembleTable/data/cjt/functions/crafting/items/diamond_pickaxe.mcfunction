...
execute if score @s cjt.stage matches 1 run function cjt:crafting/material/diamond

execute if score @s cjt.stage matches -8 run scoreboard players set @s cjt.stage 2
