...
execute as @a if score #p ht.tag matches 1.. if score @s player.score = #1p ht.tag run tag @s add 1p
execute as @a if score #p ht.tag matches 2.. if score @s player.score = #2p ht.tag run tag @s add 2p
execute as @a if score #p ht.tag matches 3.. if score @s player.score = #3p ht.tag run tag @s add 3p
