...
execute if entity @s[tag=t,tag=x] if score @s dd.timer matches 10.. run scoreboard players operation @s entity.tf.scale = @s dd.timer
execute if entity @s[tag=f,tag=x] if score @s dd.timer matches 10.. run scoreboard players operation @s entity.tf.scale = @s dd.timer